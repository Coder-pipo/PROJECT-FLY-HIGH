...
<html lang="en">
  ...
  <body>
	...
	<script id="appyWidgetInit" src="https://chatbot.appypie.com/widget/loadbuild.js?cid=ko4ed559-AGENT1619792050512-BOTID1624972583970&name=mixBuild"></script>
      ...
      <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active" data-bs-interval="10000">
            ...
            <div class="centre"><p class="text-white" aria-setsize="20">
              <marquee><font size="50" color="sky blue"><b>Welcome to Fly High!</b></font></marquee><font size="8" color="white"><br><b>“Education is the most powerful weapon which you can use to change the world” – Nelson Mandela</b></font></p></div>
          ...
          <div class="carousel-item" data-bs-interval="2000">
            <img src="robert-bye-CyvK_Z2pYXg-unsplash.jpg" class="d-block w-100" alt="...">
            <div class="centre"><p class="text-white" aria-setsize="20">
              <marquee><font size="30" color="sky blue"><b>Welcome to Fly High!</h1></b></font></marquee><font size="8" color="white"><br><b>“Teachers open the door, but you must enter by yourself” – Chinese Proverb</b></font></p></div>
            <div class="carousel-caption d-none d-md-block">
          ...
          <div class="carousel-item">
            <img src="scott-webb-O0T1SIgHAfM-unsplash.jpg" class="d-block w-100" alt="...">
            <div class="centre"><p  aria-setsize="20">
              <marquee><font size="30" color="sky blue"><b>Welcome to Fly High!</b></font></marquee><font size="8" color="white"><br><b>“Live as if you were to die tomorrow. Learn as if you were to live forever” – Mahatma Gandhi</b></font></div>
            <div class="carousel-caption d-none d-md-block">
