        ...
        <div class="row">
            ...
            <div class="col-md-3">                				
				<div class="list-group"><br>
					<h3 class="text-light">Fees of the Course</h3>
...
<div class="list-group-item checkbox">
<label><input type="checkbox" class="common_selector stream" value="Data Analytics"  >
 <?php echo "Data Analytics" ?>
</label>
</div>
<div class="list-group-item checkbox">
<label><input type="checkbox" class="common_selector stream" value="Information Security And Cloud Technology"  >
 <?php echo "Information Security And Cloud Technology" ?>
</label>
</div>
<div class="list-group-item checkbox">
<label><input type="checkbox" class="common_selector stream" value="Information Security And Mobile Applications"  >
 <?php echo "Information Security And Mobile Applications" ?>
</label>
</div>
<div class="list-group-item checkbox">
<label><input type="checkbox" class="common_selector stream" value="Cloud Technology And Mobile Applications"  >
 <?php echo "Cloud Technology And Mobile Applications" ?>
</label>
</div>
<div class="list-group-item checkbox">
<label><input type="checkbox" class="common_selector stream" value="Internet Of Things"  >
 <?php echo "Internet Of Things" ?>
</label>
</div>
<div class="list-group-item checkbox">
...
<div class="list-group-item checkbox">
<label><input type="checkbox" class="common_selector stream" value="UIX"  >
 <?php echo "UIX" ?>
</label>
</div>
<div class="list-group-item checkbox">
<label><input type="checkbox" class="common_selector stream" value="Cyber Security"  >
 <?php echo "Cyber Security" ?>
</label>
</div>
<div class="list-group-item checkbox">
<label><input type="checkbox" class="common_selector stream" value="Intelligent Process Automation"  >
 <?php echo "Intelligent Process Automation" ?>
</label>
</div>
<div class="list-group-item checkbox">
<label><input type="checkbox" class="common_selector stream" value="General"  >
...
<div class="list-group-item checkbox">
<label><input type="checkbox" class="common_selector stream" value="Game Software Development"  >
 <?php echo "Game Software Development" ?>
</label>
</div>
<div class="list-group-item checkbox">
<label><input type="checkbox" class="common_selector stream" value="Information Security And Cloud Technology"  >
...
<div class="list-group-item checkbox">
<label><input type="checkbox" class="common_selector stream" value="Database Systems"  >
 <?php echo "Database Systems" ?>
</label>
</div>
<div class="list-group-item checkbox">
<label><input type="checkbox" class="common_selector stream" value="Animation And Multimedia"  >
 <?php echo "Animation And Multimedia" ?>
</label>
</div>
                ...
                <div class="list-group"><br>
                    ...
                    $query = "SELECT DISTINCT state FROM bca WHERE college_status = '1' ORDER BY state DESC";
				...
				<div class="list-group"><br>
                    ...
                    $query = "SELECT DISTINCT city FROM bca WHERE college_status = '1'ORDER BY city DESC ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    foreach($result as $row)
				...
				<div class="list-group"><br>
                    ...
                    <div style="height: 200px; overflow-y: auto; overflow-x: hidden;">
					<?php
                    $query = " SELECT DISTINCT(university) FROM bca WHERE college_status = '1' ORDER BY university DESC";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    foreach($result as $row)
                ...
                <div class="list-group "><br>
                    ...
                    <div class="list-group-item checkbox">
                        <label><input type="checkbox" class="common_selector exam" value="CUET"  > <?php echo " CUET" ?></label>
                    </div>
                    <div class="list-group-item checkbox">
                        <label><input type="checkbox" class="common_selector exam" value="IPU CET"  > <?php echo " IPU CET" ?></label>
                    </div>
                    <div class="list-group-item checkbox">
                        <label><input type="checkbox" class="common_selector exam" value="J.E.T."  > <?php echo " J.E.T." ?></label>
                    </div>
                    <div class="list-group-item checkbox">
                    ...
                    <div class="list-group-item checkbox">
                        <label><input type="checkbox" class="common_selector exam" value="SUAT"  > <?php echo " SUAT" ?></label>
                    </div>
                    <div class="list-group-item checkbox">
                        <label><input type="checkbox" class="common_selector exam" value="SET"  > <?php echo " SET" ?></label>
                    </div>
                ...
                <div class="list-group"><br>
                    ...
                    $query = "SELECT DISTINCT type FROM bca WHERE college_status = '1' ORDER BY type DESC";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    foreach($result as $row)
                ...
                <div class="list-group"><br>
                    ...
                    $query = "SELECT DISTINCT hostel FROM bca WHERE college_status = '1' ORDER BY type DESC";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    foreach($result as $row)
                ...
                <div class="list-group"><br>
                    ...
                    $query = "SELECT DISTINCT scholarship FROM bca WHERE college_status = '1' ORDER BY scholarship DESC";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    foreach($result as $row)
